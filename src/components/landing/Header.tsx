      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          <a href="#" className="flex items-center gap-2">
            <img src={logoSoftSales} alt="SoftSales" className="h-[4.2rem] w-auto" />
          </a>
          ...
          <div className="hidden md:flex items-center gap-4">
            <Button variant="gradient" size="sm" className="glow-sm" asChild>
              <a href="https://wa.me/5534984312469?text=Ol%C3%A1!%20eu%20vim%20do%20Instagram%20e%20quero%20meu%20diagn%C3%B3stico..." target="_blank" rel="noopener noreferrer">
                Agendar diagnóstico
              </a>
            </Button>
          </div>
